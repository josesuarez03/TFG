...
\setlength{\headheight}{15.5pt}  % Aumenta la altura del encabezado
...
% Datos de portada
\title{Desarrollo de un Sistema Inteligente de Triaje Médico Automatizado para Entornos Laborales y Educativos}
\newcommand{\nombre}[0]{José Gabriel Suárez Barreto} %%% cambio de comando
\newcommand{\depto}[0]{Informática}
\newcommand{\areac}[0]{}
\author{\nombre}
\tutor{Cesar Andrés Sanchez}
\date{\today}
...
ha realizado el Trabajo final de Grado en Ingeniería Informática titulado "\makeatletter\textsc{\@title{}}\makeatother". 
