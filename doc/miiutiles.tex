...
\def\maketitle{
  ...
  % Cabecera ----------------
    \begin{center}%
    	{\noindent\Huge \textsc{UCJC}}\\[.3cm]%
    	{\noindent\Large \textsc{Grado en Informática}}\\[.3cm]%
    
    	\includegraphics[height=3cm]{img/escudoUCJC} \hfill
    	\includegraphics[height=3cm]{img/escudoInfor.pdf} \hfill
    \end{center}%
  \vfill
    \begin{center}%
      % Título proyecto y escudo informática ----------------
      {\noindent\large\textsc{Trabajo Fin de Grado}}\\[.3cm]
      \colorbox{ctitbox}{%
